...
import 'package:free_code_camp/utitlites/dialogs/error_dialog.dart';
import 'package:free_code_camp/utitlites/dialogs/password_reset_email_sent_dialog.dart';
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              const Text(
                  'If you forgot your password, Please input your email and we will mail you a password reset link'),
              TextField(
